...
class CalendarPanel extends Component {
  ...
  state = {active: false, action: "", selectedEvent: null, label: "", overtime: false, date: new Date(), view: 'work_week'}
...
CalendarPanel.propTypes = {
  ...
  massageMinutes: PropTypes.number.isRequired,
